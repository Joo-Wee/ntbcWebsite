...
export const Socials = () => {
    return (
        <div className="flex flex-row gap-4 sm:gap-6 md:gap-8">
            {/* Facebook */}
            <a href="https://web.facebook.com/New-Testament-Baptist-Church-at-Afrancho-Bronkong-104526781115548" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center w-10 h-10 rounded-3xl shadow hover:text-[#6e57e0] transition-colors">
            ...
            {/* YouTube */}
            <a href="https://youtube.com/@ntbcworldwide651?si=aq0WLqL-DqjnTpay" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center w-10 h-10 rounded-3xl shadow hover:text-[#6e57e0] transition-colors">
