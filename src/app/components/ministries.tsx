    ...
    return(
        <section className="ps-[6vw] pe-[6vw]">
                <div className="text-[32px] w-full py-[1vw] font-bold text-[#003867]">
                    <h1 className="max-[900px]:text-3xl text-center max-[900px]:ml-[2rem]">Our Ministries</h1>
                </div>

                <div className="ps-[6vw] pe-[6vw] flex flex-col">
                    <div className="py-8">
                    ...
                    <div className="max-[900px]:justify-center flex w-full justify-between gap-5 flex-wrap">
                        {ministries.map((ministry, index) => (
                            <div
                            key={index}
                            className="max-[540px]:w-full max-[900px]:w-4/5 relative flex justify-center items-center flex-col w-[30%] h-auto"
                          >
                            <div className="w-full h-auto rounded-3xl shadow-xl border-b-3 border-[#ff0912] py-2 group">
                              <div className="relative overflow-hidden rounded-md">
                                <Image
                                  ...
                                  width={500}
                                  height={500}
                                  className="w-full h-auto object-cover md:w-full"
                                />
