...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {children}
        <footer className="w-full flex flex-col items-center bg-[#F8F8F8] py-10 px-6 md:px-16 border-t border-gray-200">
          <div className="w-full max-w-6xl flex flex-col md:flex-row justify-between items-stretch gap-y-10 gap-x-12">
            {/* Logo & Contact */}
            <div className="flex flex-col h-full items-start min-w-[200px] flex-1 py-2">
              ...
              <a href="mailto:worldwidentbc@gmail.com" className="text-[#ff0912] hover:underline">worldwidentbc@gmail.com</a>
            </div>
            ...
            {/* Branches/Locations */}
            <div className="flex flex-col h-full flex-1 min-w-[180px] py-2">
          ...
          {/* Copyright */}
          <div className="w-full text-xs text-[#003867] mt-10 text-center">
